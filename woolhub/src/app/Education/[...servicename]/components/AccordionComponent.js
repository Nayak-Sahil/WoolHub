  ...
  return (
    <>
      <Accordion open={openAccordion === 1} icon={<Icon id={1} open={openAccordion} />}>
        <AccordionHeader className='text-md py-0 pb-3' onClick={() => handleOpenAccordion(1)}>What is the purpose of the app-based solution for the wool sector in India?</AccordionHeader>
        <AccordionBody>
      ...
      <Accordion open={openAccordion === 2} icon={<Icon id={2} open={openAccordion} />}>
        <AccordionHeader className='text-md py-0 pb-3' onClick={() => handleOpenAccordion(2)}>
      ...
      <Accordion open={openAccordion === 3} icon={<Icon id={3} open={openAccordion} />}>
        <AccordionHeader className='text-md py-0 pb-3' onClick={() => handleOpenAccordion(3)}>
      ...
      <Accordion open={openAccordion === 4} icon={<Icon id={4} open={openAccordion} />}>
        <AccordionHeader className='text-md py-0 pb-3' onClick={() => handleOpenAccordion(4)}>
      ...
      <Accordion open={openAccordion === 5} icon={<Icon id={5} open={openAccordion} />}>
        <AccordionHeader className='text-md py-0 pb-3' onClick={() => handleOpenAccordion(5)}>
