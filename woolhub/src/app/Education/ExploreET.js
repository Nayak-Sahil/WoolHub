...
import etfront from "../../../public/Assets/Images/Education/bgimg1.jpg"
      ...
      <div
        ...
        <div className="flex h-full items-center justify-center">
          <div className="text-slate-950 h-full w-full flex flex-col items-center justify-around">
            <h1 className="mb-4 text-white text-4xl font-semibold">Discover the Art of Wool: <span className="mt-5 block">Ignite Your Creativity and Skills.</span></h1>
            ...
            <ScrollTo targetId="#services">
              <button
                href="#services"
                type="button"
                className="rounded-full text-sm font-medium uppercase leading-normal text-white transition duration-150 ease-in-out hover:text-slate-1000 focus:border-neutral-100 focus:text-neutral-100 focus:outline-none focus:ring-0 active:border-neutral-200 active:text-neutral-200 h-20 relative" data-te-ripple-init
