...
export default function Contact() {
    return (
        <section className="px-20 relative z-10 overflow-hidden bg-white lg:py-[120px]">
                ...
                <div className="-mx-4 flex flex-wrap lg:justify-between">
                    <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                        <div className="mb-12 max-w-[570px] lg:mb-0">
                            ...
                            Have questions, feedback, or inquiries? We'd love to hear from you! Our dedicated team is here to assist you in any way we can.
                            </p>
                            <div className="mb-8 flex w-full max-w-[450px]">
                                ...
                                <div className="w-full">
                                    <h4 className="text-dark mb-1 text-xl font-bold">Central Wool Development Board</h4>
                                    <p className="text-body-color text-base">
                                    123 -, Opp. Post Office Bhagat Ki Kothi,
Pali Road, Jodhpur 342001 Rajasthan (INDIA)
                                    </p>
                                </div>
                            </div>
                            <div className="mb-8 flex w-full max-w-[450px]">
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-body-color text-base">0091-291-2433967, 2616328</p>
                                </div>
                            </div>
                            <div className="mb-8 flex w-full max-w-[450px]">
                                <div
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-body-color text-base">woolboard-textiles@gov.in</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                        <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                            ...
                            <div>
                                <span className="absolute top-1 -right-9 z-[-1]">
                                    <svg
                                        width="34"
                                        height="134"
                                        viewBox="0 0 34 134"
